...
const ThreeDTestimonials: React.FC = () => (
  <Canvas camera={{ position: [0, 0, 8], fov: 60 }} style={{ height: '100vh', width: '100vw' }} shadows>
    ...
    <Html position={[0, -2.5, 0]} center>
      <h2 style={{ color: 'white', fontSize: '1.5rem' }}>Testimonials</h2>
      <p style={{ color: 'white' }}>This is my 3D Testimonials page!</p>
    </Html>
    <OrbitControls />
  </Canvas>
);
